  ...
  >
    <div>
      <div style="width: 100%" class="align-center mt-4 mb-8">
        <branch-list-select
          :value="info.clientstationcode"
          style="width: 100%"
          :placeholder="$t('l_Branch_warehouse')"
          @set-station-code="(e) => (info.clientstationcode = e)"
        ></branch-list-select>
      </div>
    </div>
  </a-modal>
...
export default {
  ...
  methods: {
    onSubmit() {
      ...
      http('order/change-station-code', {
