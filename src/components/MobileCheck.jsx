const MobileCheck = ({ children }) => {
    return (
        <>
            ...
            {/* Desktop Warning */}
            <div className="hidden md:flex min-h-screen flex-col items-center justify-center px-4 text-center bg-gold-base/5">
                <div className="max-w-lg mx-auto">
                    <h1 className="text-3xl text-gold-base script-font mb-4">Құрметті қонақ!</h1>
